...
public class GameRules {
    ...
    final private Location[] locations = { new Location(270, 0, true), new Location(558, 288, false),
	    new Location(270, 576, true), new Location(-18, 288, false) };

    final private Color[] colours = { Color.CADETBLUE, Color.CRIMSON, Color.GOLD, Color.GREEN };
